...
contract UniSwap{
    ...
    function convertExactDaiToEth(uint _daiAmount, address _recipient) external 
    {
        require(_daiAmount > 0, "Dai amount must be greater than zero");

        //transfer required amount DAI to this contract
    ...
    function exactInputMultiHop(uint _amountIn, address _recipient) external
    {
